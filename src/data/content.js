...
export const works = [
  ...
  },
  {
    ...
    type: 'document',
    documents: [
      { name: '2024励骏庞都暑期活动方案', category: '活动方案' },
      { name: '2025励骏3-4月春季活动方案', category: '活动方案' },
      { name: '2025暑期花样交友季方案', category: '活动方案' },
      { name: '2025霸王餐抽奖活动方案', category: '活动方案' },
      { name: '2024励骏庞都暑期活动总结报告', category: '总结报告' },
      { name: '总结及2025年度计划', category: '总结报告' },
      { name: '活动信息表 Event Sheet', category: 'SOP标准' },
      { name: '活动入场须知 V10', category: 'SOP标准' },
      { name: '场地临时租赁收费标准', category: '报价体系' },
      { name: '广告资源报价单', category: '报价体系' },
      { name: '啤酒露营节补贴备案文件', category: '补贴申报' },
      { name: '垃圾分类主题展览月方案', category: '策展规划' },
    ],
  },
]
