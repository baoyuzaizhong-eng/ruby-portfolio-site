...
export const works = [
  ...
  },
  {
    ...
    documents: [
      ...
      { name: '2024励骏庞都暑期活动总结报告', category: '总结报告', file: '/assets/docs/2024励骏庞都暑期活动总结报告.pdf' },
      ...
      { name: '场地临时租赁收费标准', category: '报价体系', file: '/assets/docs/场地临时租赁收费标准.pdf' },
      { name: '广告资源报价单', category: '报价体系', file: '/assets/docs/广告资源报价单.pdf' },
      { name: '啤酒露营节补贴备案文件', category: '补贴申报', file: '' },
      { name: '垃圾分类主题展览月方案', category: '策展规划', file: '/assets/docs/垃圾分类主题展览月方案.pptx' },
    ],
  },
]
